...
export default function BottomNav() {
  return (
    <footer className="fixed inset-x-0 bottom-0 pb:calc(20px + env(safe-area-inset-bottom)) flex w-full border-t border-gray-300 bg-gradient-to-t from-zinc-200 dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:border lg:bg-gray-200 lg:dark:bg-zinc-800/30">
      <Link
